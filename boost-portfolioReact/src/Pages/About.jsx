...
const AboutMe = () => {
  return (
    <>
      ...
      >
        <Row>{/* Header row left */}</Row>
        <Row
          style={{ marginTop: "4em" }}
          className="d-flex justify-content-center"
        >
          <Col md={3} style={{ marginRight: "1.5em", marginLeft: "2em" }}>
            {/* Left column */}
...
",
          ...
          <Col md={6} style={{ marginLeft: "1.5rem" }}>
            {/* Right Column */}
            <Row>
              <Col></Col>
              <Col md={11}>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  I make custom themes on these websites, and really made
                  editing html a hobby when tumblr rolled around. I've made all
                  of the front end mistakes that are physically possible. Like
                  yellow text on a red background. Look at me now! This entire
                  website was coded by hand using bootstrap and React! Isn't
                  that neat?{" "}
                </p>
              </div>
              ...
              <Row>
                ...
                <Row>
                  ...
                  >
                    ...
                    boundaries and deliver lasting value. Also, I'm always on
                    the computer anyway. So, I thought it would be good to
                    challenge myself and learn how to make cool things.{" "}
                  </p>
                </Row>
              </Row>
              {/* <Row>
          ...
          <Row>
            ...
            <CardGroup className="techStack" style={{ maxWidth: "100%" }}>
          ...
          >
            <Row>
              ...
              <button
                ...
                href="/assets/Pearson Richelle Resume.pdf"
                target="_blank"
                rel="noopener noreferrer"
              >
                Download ATS Resume Resume
              </button>
            </Row>
            ...
            <Row>
              <Accordion style={{ width: "75^%" }}>
                <AccordionItem eventKey="0">
                  ...
                  <AccordionBody>
                    <ul>
                      ...
                      <li>
                        {" "}
                        The process required creating eligibility criteria for
                        these top client{" "}
                      </li>
                      <li>
                        {" "}
                        Created monetization opportunities for clients that did
                        not meet criteria to increase spend
                      </li>
                      <li>
                        {" "}
                        Oversaw the entire project management life cycle of the
                        job matching initiative.
                      </li>
                      <li>
                        {" "}
                        Initial goal of 9% coverage was met in phase 1 allowing
                        for additional expansion phases leading to a total of
                        22% job coverage by end of phase 2.{" "}
                      </li>
                      <li>
                        {" "}
                        Defined overall scope and managed execution as well as
                        oversaw two additional expansion phases
                      </li>
                      <li>
                        {" "}
                        Developing instructions / guidelines for our external
                        vendor team of 10 to execute. Rolling out training and
                        audit schedule to the vendor team
                      </li>
                      <li>
                        {" "}
                      ...
                      <li>
                        {" "}
                        Direct project management experience with large-scale
                        operations team, resulting in a 20% reduction to the
                        team's turnaround time
                      </li>
                      <li>
                        {" "}
                        Developed project timeline and milestone tracking to fit
                        within Agile workflows
                      </li>
                      <li>
                        {" "}
                        Defined requirements and subsequently executed
                        salesforce case research into prolonged turnaround time
                      </li>
                      <li>
                        {" "}
                        Collaborated with external product team and CRM team to
                        create a specialized Salesforce Case Record and
                        subtypes.{" "}
                      </li>
                      <li>
                        {" "}
                        Created the business case to submit to leadership by
                        defining technical requirements. Working closely with
                      ...
                      <li>
                        {" "}
                        Implemented an Office Hours Program, working to provide
                        ad-hoc support and policy clarification for Client
                        Support & Sales throughout 2022 and 2023.{" "}
                      </li>
                      ...
                      <li>
                        {" "}
                        Expanded program to accommodate EMEA teams and Global
                ...
                <AccordionItem eventKey="1">
                  <AccordionHeader>
                    {" "}
                    Colosseum Athletics - Social Media Intern Nov 2019 – April
                    2020{" "}
                  </AccordionHeader>
                  <AccordionBody>
                    <ul>
                      <li>
                        Increased conversion rates on email marketing newsletter
                        by 0.5% by improving formatting, all CTAs and
                        interesting email subjects in MailChimp
                      </li>
                      <li>
                        Consistently managed multiple social media accounts A
                        schedules (Facebook, Instagram){" "}
                      </li>
                      <li>
                        Created unique marketing materials that served to
                        establish a brand voice
                      </li>

                      <li>
                        {" "}
                        Successfully promoted merchandise sales by utilizing
                        professional relationships with brand ambassadors and
                        Instagram influencers.{" "}
                      </li>
                      <li>
                        Constructed in-house photo shoots to create engaging
                        polished content for websites and social media.{" "}
                      </li>
                    </ul>
                  </AccordionBody>
                </AccordionItem>
            ...
            >
              ...
              >
                ...
                <AccordionItem eventKey="3">
                  ...
                  <AccordionBody>
                    {" "}
                    User Expirence Certification Course
                  </AccordionBody>
                </AccordionItem>
                <AccordionItem eventKey="1">
                  <AccordionHeader>
                    {" "}
                    Hongik University, South Korea 2017
                  </AccordionHeader>
                  <AccordionBody>
                    {" "}
                    Study Abroad program, Communication Design
                  </AccordionBody>
                </AccordionItem>
                ...
                <AccordionItem eventKey="2">
                  <AccordionHeader>
                    {" "}
                    Long Beach City College 2015- 2017
                  </AccordionHeader>
